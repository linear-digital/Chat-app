...
function Profile(props) {
  ...
  const { current_user } = useSelector((state) => state.ChatPro)
            ...
            <Card className="shadow-none border mb-2">
              ...
              >
                ...
                <div className="mt-4">
                  ...
                  <h5 className="font-size-14">{t(current_user.email)}</h5>
                </div>

                <div className="mt-4">
                  <p className="text-muted mb-1">{t("Join")}</p>
                  <h5 className="font-size-14">{moment(current_user.createted_at).format("dddd, MMMM Do YYYY")}</h5>
                </div>

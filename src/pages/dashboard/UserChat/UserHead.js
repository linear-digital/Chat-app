...
function UserHead(props) {
    ...
    useEffect(() => {
        if (props.selected_user) {
            setSelected(props.selected_user)
        }
        else {
            setSelected({
                "name": "Mr. User",
                        ...
                        <div className="d-flex align-items-center">
                            ...
                            </div>
                            {
                                ...
                                <div className="me-3 ms-0">
                                    <img src={selected.photo || avatar} className="rounded-circle avatar-xs" alt="chatvia" />
                                </div>
...
const mapStateToProps = (state) => {
    ...
    const { selected_user } = state.ChatPro
    return { ...state.Layout, users, active_user, selected_user };
};

...
function UserProfileSidebar(props) {
    const { selected_user } = useSelector(state => state.ChatPro);
            ...
            <div style={{ display: (props.userSidebar === true) ? "block" : "none" }} className="user-profile-sidebar">
                ...
                <div className="text-center p-4 border-bottom">
                    ...
                    <div className="mb-4 d-flex justify-content-center">
                        {
                            selected_user.photo === "Null" ?
                                <div className="avatar-lg">
                                    <span className="avatar-title rounded-circle bg-primary-subtle text-primary font-size-24">
                                        {selected_user.name.charAt(0)}
                                    </span>
                                </div>
                                : <img src={selected_user.photo} className="rounded-circle avatar-lg img-thumbnail" alt="chatvia" />
                        }
                        ...
                        <Card className="shadow-none border mb-2">
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <h5 className="font-size-14">{selected_user?.name}</h5>
                                </div>

                                <div className="mt-4">
                                    <p className="text-muted mb-1">{t('Email')}</p>
                                    <h5 className="font-size-14">{selected_user?.email}</h5>
                                </div>


                                <div className="mt-4">
                                    <p className="text-muted mb-1">{t('Location')}</p>
                                    <h5 className="font-size-14 mb-0">{selected_user.location}</h5>
                                </div>
